...
@Component({
  selector: 'app-despachadas',
  templateUrl: './despachadas.component.html',
  styleUrls: ['./despachadas.component.scss'] 
})
export class DespachadasComponent implements OnInit {
