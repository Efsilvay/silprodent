...
@Component({
  selector: 'app-informadas',
  templateUrl: './informadas.component.html',
  styleUrls: ['./informadas.component.scss']
})
export class InformadasComponent implements OnInit {
  allDatos: any = []; 
  datosOrdenes: any = [];
