...
@Component({
  selector: 'app-recepcionadas',
  templateUrl: './recepcionadas.component.html',
  styleUrls: ['./recepcionadas.component.scss']
})
export class RecepcionadasComponent implements OnInit {
  allDatos: any = []; 
  datosOrdenes: any = [];
